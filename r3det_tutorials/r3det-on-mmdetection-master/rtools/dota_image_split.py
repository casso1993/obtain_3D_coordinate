...
if __name__ == '__main__':
    trainsplit = DOTAImageSplitTool('/home/casso/r3det_tutorials/r3det-on-mmdetection-master/data/dota/train',
                                    '/home/casso/r3det_tutorials/r3det-on-mmdetection-master/data/dota/trainsplit',
                                    tile_overlap=(150, 150),
                                    tile_shape=(600, 600))
    trainsplit.split()
    valsplit = DOTAImageSplitTool('/home/casso/r3det_tutorials/r3det-on-mmdetection-master/data/dota/val',
                                  '/home/casso/r3det_tutorials/r3det-on-mmdetection-master/data/dota/valsplit',
                                  tile_overlap=(150, 150),
                                  tile_shape=(600, 600))
    valsplit.split()
